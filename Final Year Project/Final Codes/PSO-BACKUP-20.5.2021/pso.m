...
nPop = 120;        % Population Size (Swarm Size)
...
grid on;
%save figure
saveas(figure(1),[pwd (sprintf('/120 Pop/PSO_120_%d.png',z))]);
...
xlswrite('C:\Users\youse\Desktop\PSO-MODIFY\120 Pop\results.xls',Data)